...
Find the setting for ‘imagePullPolicy: Always’. Put the cursor to the end of the line. Hit return. Underneath enter:
...
Find ‘restartPolicy: Always’. Put the cursor to the end of the line and press return. Underneath enter:
